            ...
            <form method="POST" action="{{ route('register.post') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative input-group">
                        ...
                        <input id="password" name="password" type="password"
                               class="form-input pl-11 pr-10 @error('password') border-red-400 focus:ring-red-400 @enderror"
                               placeholder="Minimal 6 karakter" required>
                        <button type="button" onclick="togglePasswordVisibility('password', 'eye-icon-pass')" class="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-slate-600 focus:outline-none" aria-label="Tampilkan Kata Sandi">
                ...
                <div>
                    ...
                    <div class="relative input-group">
                        ...
                        <button type="button" onclick="togglePasswordVisibility('password_confirmation', 'eye-icon-confirm')" class="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-slate-600 focus:outline-none" aria-label="Tampilkan Konfirmasi Kata Sandi">
...
<script>
    function togglePasswordVisibility(inputId, iconId) {
        ...
        if (input.type === 'password') {
            input.type = 'text';
            // Ubah SVG menjadi ikon mata terbuka (eye-open / password terlihat)
            icon.innerHTML = `
            ...
            input.type = 'password';
            // Kembalikan ke ikon mata dicoret (eye-off / password tersembunyi)
            icon.innerHTML = `
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l18 18" />
            `;
        }
