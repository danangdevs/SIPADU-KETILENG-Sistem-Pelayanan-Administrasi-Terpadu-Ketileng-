...
<head>
    ...
    <style>
        ...
        @media (min-width: 1024px) {
            ...
            .login-tagline  { color: #059669 !important; }  /* emerald-600 */
...
<div class="flex min-h-screen">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-slate-950">
        ...
        <div class="absolute inset-0 bg-cover bg-center transition-all duration-700 transform scale-105 hover:scale-100" 
             style="background-image: url('{{ asset('images/bg_desa.png') }}'), url('https://images.unsplash.com/photo-1508672019048-805c876b67e2?q=80&w=1200&auto=format&fit=crop');">
        </div>
        ...
        <div class="relative z-10 flex flex-col justify-between p-10 w-full">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-emerald-300/90 font-semibold text-xs mt-0.5 tracking-wide">Governance Portal</p>
                </div>
            </div>
    ...
    {{-- RIGHT: Form Login --}}
    <div class="flex-1 flex items-center justify-center p-6 sm:p-12 md:p-16 bg-slate-950 lg:bg-white relative">
        ...
        <div class="w-full max-w-md space-y-8 relative z-10 p-0 bg-transparent border-none shadow-none">
            ...
            <div class="lg:hidden flex items-center gap-2 mb-6">
                ...
                <span class="font-bold text-white">Desa Ketileng</span>
            </div>

            <div class="space-y-3">
                <p class="login-tagline text-[11px] font-bold text-emerald-400 uppercase tracking-widest mobile-text-shadow">Sistem Administrasi Terpadu</p>
                <h2 class="login-heading text-4xl font-extrabold text-white tracking-tight mobile-text-shadow">Selamat Datang</h2>
                <p class="login-desc text-white/90 text-sm leading-relaxed mobile-text-shadow font-medium">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="login" name="login" type="text"
                               value="{{ old('login') }}"
                               class="login-input form-input bg-white/10 text-white placeholder-white/50 border-white/30 focus:bg-white/15 focus:border-emerald-400 pl-11 @error('login') border-red-400 focus:ring-red-400 @enderror"
                ...
                <div>
                    ...
                    <div class="relative" style="position: relative;">
                        ...
                        <input id="password" name="password" type="password"
                               class="login-input form-input bg-white/10 text-white placeholder-white/50 border-white/30 focus:bg-white/15 focus:border-emerald-400 pl-11 pr-10 @error('password') border-red-400 @enderror"
            ...
            <div class="text-center space-y-3 pt-6 border-t border-white/20 lg:border-slate-200">
                <p class="login-footer text-white font-medium mobile-text-shadow text-sm">
                    Belum punya akun?
                    <a href="{{ route('register') }}" class="text-emerald-300 lg:text-emerald-600 font-bold hover:text-emerald-400 lg:hover:text-emerald-700 transition-colors">
                        Daftar di sini
                    </a>
                </p>
                <p class="login-help text-white font-medium mobile-text-shadow text-xs">
                    Butuh bantuan?
                    <a href="https://wa.me/6281234567890" class="login-help-link text-white font-bold mobile-text-shadow hover:text-emerald-300 lg:hover:text-emerald-600 transition-colors">
